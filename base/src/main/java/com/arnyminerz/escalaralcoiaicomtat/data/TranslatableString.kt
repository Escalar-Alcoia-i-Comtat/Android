...
class TranslatableString(private val string: String) {
    ...
    constructor(context: Context, @StringRes res : Int, vararg placeholders : String) : this(context.getString(res).format(placeholders))
    constructor(context: Context, @StringRes res : Int, placeholders : ArrayList<String>) : this(context.getString(res).format(placeholders))
